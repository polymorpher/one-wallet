...
contract('ONEWallet', (accounts) => {
  ...
  it('Wallet_CommitReveal: ERC20(Transfer, Mint, Track) must commit and reveal successfully', async () => {
    ...
    const {testerc20, testerc20d9, testerc721, testerc1155} = makeTokens(accounts)
...
const makeTokens = async (accounts) => {
  // create an ERC20
  ...
  const testerc20d9 = await TESTERC20DECIMALS9.new(10000000)
  // create an ERC721
